...
public class FContactDetailsActivity extends AppCompatActivity {
    ...
    @Bind(R.id.txtAddress1) protected TextView txtAddress1;
    @Bind(R.id.txtAddress2) protected TextView txtAddress2;
    @Bind(R.id.txtAddress3) protected TextView txtAddress3;
    @Bind(R.id.txtAddress4) protected TextView txtAddress4;
    @Bind(R.id.txtTown) protected TextView txtTown;
    @Bind(R.id.txtCounty) protected TextView txtCounty;
    @Bind(R.id.txtPostcode) protected TextView txtPostcode;
    @Bind(R.id.txtCountry) protected TextView txtCountry;
    ...
    private void setDetailsToView() {
        if (contactEntity != null) {
            ...
            if (contactEntity.Address != null) {
                if (contactEntity.Address.Address1 != null && !contactEntity.Address.Address1.equalsIgnoreCase(""))
                    txtAddress1.setText(contactEntity.Address.Address1);
                else
                    txtAddress1.setVisibility(View.GONE);

                if (contactEntity.Address.Address2 != null && !contactEntity.Address.Address2.equalsIgnoreCase(""))
                    txtAddress2.setText(contactEntity.Address.Address2);
                else
                    txtAddress2.setVisibility(View.GONE);

                if (contactEntity.Address.Address3 != null && !contactEntity.Address.Address3.equalsIgnoreCase(""))
                    txtAddress3.setText(contactEntity.Address.Address3);
                else
                    txtAddress3.setVisibility(View.GONE);

                if (contactEntity.Address.Address4 != null && !contactEntity.Address.Address4.equalsIgnoreCase(""))
                    txtAddress4.setText(contactEntity.Address.Address4);
                else
                    txtAddress4.setVisibility(View.GONE);

                if (contactEntity.Address.Town != null && !contactEntity.Address.Town.equalsIgnoreCase(""))
                    txtTown.setText(contactEntity.Address.Town);
                else
                    txtTown.setVisibility(View.GONE);

                if (contactEntity.Address.County != null && !contactEntity.Address.County.equalsIgnoreCase(""))
                    txtCounty.setText(contactEntity.Address.County);
                else
                    txtCounty.setVisibility(View.GONE);

                if (contactEntity.Address.Postcode != null && !contactEntity.Address.Postcode.equalsIgnoreCase(""))
                    txtPostcode.setText(contactEntity.Address.Postcode);
                else
                    txtPostcode.setVisibility(View.GONE);

                if (contactEntity.Address.Country != null && !contactEntity.Address.Country.equalsIgnoreCase(""))
